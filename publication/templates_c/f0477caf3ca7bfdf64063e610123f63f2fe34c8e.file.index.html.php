...
<head>
  <meta charset="utf-8">
  <title>Deje de criticar y véngase a trabajar | Cambio Radical</title>
  <meta name="description" content="Deje de criticar y véngase a trabajar">
...
<body>
  ...
  <header class="container-fluid">
    <div class="row">
      <!--Logo Cambio Radical-->
      <div class="logo"><svg version="1.1" id="logo-cr" xmlns="http://www.w3.org/2000/svg" width="148.814px" height="67.528px" viewBox="0 0 148.814 67.528" xml:space="preserve">
<g>
	...
	<path fill="#134690" d="M55.735,62.048c0.028,1.425,0.061,3.226,0.104,5.025c0.005,0.19-0.028,0.255-0.234,0.252
      ...
      <!--/-Logo Cambio Radical-->
      <h1 class="text-title"><strong>deje de criticar y</strong><span>véngase a trabajar</span></h1>
    </div>
  </header>
  <!--/-Header-->
  <section class="container-fluid">
    <form class="row" id="trabajo" method=""><small>
...
';">Conéctate con Facebook</button>
  ...
  <footer class="container-fluid">
    <div class="row">
      <!--Seamos el cambio--><img src="images/seamos-el-cambio.png" title="Seamos el Cambio" alt="Seamos el Cambio"/>
      <!--/-Seamos el cambio-->
      <p><a href="http://www.partidocambioradical.org" target="_Blank">www.partidocambioradical.org</a></p>
    </div>
  </footer>
  <!--/-Footer-->
  <!--Scripts-->
